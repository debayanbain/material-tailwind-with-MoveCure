            ...
            <section className="container mx-auto px-4 py-8 max-w-3xl">
                ...
                <div className="mt-8 space-y-6 text-gray-700 leading-relaxed">
                    ...
                    <p>
                        ...
                        <Link href='/' className='underline text-blue-400 ml-1'>https://movecure.store</Link> Website, including the related mobile site and mobile application
                        hereinafter referred to as Platform.
                    </p>

                    <p>
                        The Platform is owned by <span className='underline font-bold'>Sayan Saha</span>, a company incorporated under the Companies Act, 1956
                        with its registered office at Barrackpore M P Uddan ,Kolkata ,India hereinafter referred to as
