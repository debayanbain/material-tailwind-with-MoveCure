        ...
        <div className="bg-white min-h-screen">
            <section className="container mx-auto px-4 py-8 max-w-3xl">
                ...
                <div className="mt-8 space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <p>
                        This Privacy Policy describes how Sayan Saha and its affiliates (collectively Sayan Saha, we, our, us)
                        collect, use, share, protect or otherwise process your information/ personal data through our website
                        https://movecure.store (hereinafter referred to as Platform). Please note that you may be able to browse
                    ...
                    <p>
                        ...
                        any information. If you receive an email, a call from a person/association claiming to be Sayan Saha
                    ...
                    <div className='text-2xl font-bold'>Sharing</div>
                    <p>
                    ...
                    <div className='text-2xl font-bold'>Security Precautions</div>
                    <p>
                    ...
                    <div className='text-2xl font-bold'>Data Deletion and Retention</div>
                    <p>
                    ...
                    <div className='text-2xl font-bold'>Your Rights</div>
                    <p>
                    ...
                    <div className='text-2xl font-bold'>Changes to this Privacy Policy</div>
                    <p>
